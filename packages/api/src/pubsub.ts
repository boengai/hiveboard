...
export function publishAgentLog(taskId: string, chunk: { taskId: string; chunk: string; timestamp: string }) {
  pubsub.publish('AGENT_LOG', taskId, chunk as unknown as Record<string, unknown>)
}
